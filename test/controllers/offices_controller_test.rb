...
class OfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post offices_url, params: { office: { city: @office.city, direction: @office.direction, manager: @office.manager, name: @office.name, phone: @office.phone, position: @office.position, signature: @office.signature, status: @office.status } }
    end
  ...
  test "should update office" do
    patch office_url(@office), params: { office: { city: @office.city, direction: @office.direction, manager: @office.manager, name: @office.name, phone: @office.phone, position: @office.position, signature: @office.signature, status: @office.status } }
