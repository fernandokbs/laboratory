...
class ServicesTest < ApplicationSystemTestCase
  ...
  test "creating a Service" do
    ...
    fill_in "Amount", with: @service.amount
    fill_in "Classification", with: @service.classification_id
    fill_in "Organ", with: @service.organ_id
    fill_in "Tabulator", with: @service.tabulator_id
    fill_in "Type service", with: @service.type_service_id
